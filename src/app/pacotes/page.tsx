  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-16">
      <div className="text-center">
        <h1 className="text-4xl font-extrabold text-brand-blue">Planos e Pacotes</h1>
        <p className="mt-3 text-brand-blue/60">Sem taxas escondidas. Cancele quando quiser.</p>
      </div>
      ...
      {/* FAQ rápido */}
      <div className="mt-20">
        <h2 className="text-center text-2xl font-bold text-brand-blue">Perguntas frequentes</h2>
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {[
            ...
            >
              <p className="font-semibold text-brand-blue">{q}</p>
              <p className="mt-2 text-sm text-brand-blue/60">{a}</p>
            </div>
          ))}
        </div>
      </div>
